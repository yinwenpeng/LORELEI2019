...
def load_il10_with_ground_truth():
    '''
    ...
    folder = '/scratch/wyin3/dickens_save_dataset/LORELEI/il10/monolingual_text/'
    docid2text={}
    re=0
    ...
    folder = '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il10/source/il10_unseq/setE/data/annotation/il10/situation_frame/issues/'
    files= os.listdir(folder)
    ...
    mentions: doc_id:[{'entity_id': place_id, 'entity_type': GPE, 'start_char':12,'end_char':15}]
    '''
    folder = '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il10/source/il10_unseq/setE/data/annotation/il10/situation_frame/mentions/'
    files= os.listdir(folder)
    ...
    '''
    docid2need = {}
    folder = '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il10/source/il10_unseq/setE/data/annotation/il10/situation_frame/needs/'
    files= os.listdir(folder)
...
def generate_entity_focused_trainingset(docid2text, docid2issue, docid2mention, docid2need):
    ...
    writefile = codecs.open('/home/wyin3/LORELEI/2019/experiments_daily/il10_labeled_as_training_seg_level.txt', 'w', 'utf-8')
    write_size = 0
...
def translate_bbn_2_il10():
    '''load il9 dictionary'''
    readfile = codecs.open('/shared/corpora/corporaWeb/lorelei/evaluation-2018/il10/source/il10/set0/docs/categoryI_dictionary/IL10_dictionary.txt', 'r', 'utf-8')
    eng2il9={}
    for line in readfile:
        parts = line.strip().split('\t')
    ...
    writefile = codecs.open('/scratch/wyin3/dickens_save_dataset/LORELEI/SF-BBN-Mark-split/full_BBN_multi_translated_2_il10.txt', 'w', 'utf-8')
    for line in readfile:
    ...
    writefile.close()
    writefile.close()
    print('translate bbn to il10 over')
...
if __name__ == '__main__':
    ...
    # docid2text, docid2issue, docid2mention, docid2need = load_il10_with_ground_truth()
    # generate_entity_focused_trainingset(docid2text, docid2issue, docid2mention, docid2need)

    translate_bbn_2_il10()
