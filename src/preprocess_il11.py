...
def translate_bbn_2_il():
    '''load il dictionary'''
    readfile = codecs.open('/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11/source/il11/set0/docs/categoryI_dictionary/IL11_dictionary.txt', 'r', 'utf-8')
    eng2il9={}
    for line in readfile:
        parts = line.strip().split('\t')
    ...
    writefile = codecs.open('/scratch/wyin3/dickens_save_dataset/LORELEI/SF-BBN-Mark-split/full_BBN_multi_translated_2_il11.txt', 'w', 'utf-8')
    for line in readfile:
    ...
    writefile.close()
    writefile.close()
    print('translate bbn to il11 over')
...
if __name__ == '__main__':
    ...
    set_E_mono_text = '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11/source/il11/setE/data/monolingual_text/il11/ltf/'
    MT_input = '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/MT/'
    EDL_input = [
    '/shared/corpora/corporaWeb/lorelei/evaluation-2019/il11/edl_output/7.24_il11_bert0_tsl0_google1_top1_map1_gtrans0_wc1_ed0_l2smap1_mtype0_wikicg0_spell0_or2hin1_clas0/nilcluster_exact.tab',
    '/shared/corpora/corporaWeb/lorelei/evaluation-2019/il11/edl_output/7.24_il11_bert0_tsl1_google1_top1_map1_gtrans1_wc1_ed0_l2smap1_mtype1_wikicg0_spell0_or2hin1_clas0/nilcluster_exact.tab']
    output_file = '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11-setE-as-test-input_edl1_filtered'
