...
if __name__ == '__main__':
    ...
    emb_paths = [[emb_root+'cleaned-100k-il11longerw2v-multicca.d300.eng.txt',
                emb_root+'cleaned-100k-il11longerw2v-multicca.d300.il11longerw2v.txt'],
                [emb_root+'cleaned-100k-il11longerw2vfulldict-multicca.d300.eng.txt',
                emb_root+'cleaned-100k-il11longerw2vfulldict-multicca.d300.il11longerw2vfulldict.txt']]



    '''test setup'''
    test_file_paths = [
    # '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11-setE-as-test-input_edl0_filtered_w2.txt',
    '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11-setE-as-test-input_edl1_filtered_w2.txt',
    # '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/il11-setE-as-test-input_edl_filtered_w2.txt'
    ]
    '''
    ...
    output_file_head = '/scratch/wyin3/dickens_save_dataset/LORELEI/il11/sf_output_ch2/il11_system_output_'
    '''setup over'''
    if use_bert:
        print('loading bert...')
