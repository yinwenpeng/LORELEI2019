...
# bert_path = '/shared/experiments/kkarthi/nlpgrid_Extend_mbert/Extend_mbert/il9/il9_V1_1M'
# bert_path = '/scratch/wyin3/dickens_save_dataset/LORELEI/il9/FewLingBertJamaal/il11+il12_Out/600k+Steps'
bert_path = '/shared/experiments/kkarthi/Extend_mbert/il9/il9_500k'
if use_bert:
...
class Encoder(nn.Module):
    ...
    def forward(self, sentence, seq_lengths, mask, label_sent, label_mask, bert_rep_batch):
        ...
        if  use_bert:
            tag_space = self.bert_hidden2tag(combine_rep_batch)
            tag_prob = tag_space.sigmoid()
            '''task 2'''
            tag_space_task2 = self.bert_hidden2tag_task2(combine_rep_batch)
