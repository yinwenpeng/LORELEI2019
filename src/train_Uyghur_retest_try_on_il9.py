...
def train(task1_data,task2_data,test_data, label_sent, label_mask, test_lines, epoch_num, model, loss_function, optimizer):
    ...
    for epoch in range(epoch_num):
        ...
        for i, minibatch in enumerate(minibatches_idx):
            ...
            tag_scores,_= model(sentence_batch, seq_lengths, mask_batch, label_sent, label_mask)
            ...
            if i < len(minibatches_idx_task2):
                ...
                tag_scores, tag_scores_task2= model(sentence_batch, seq_lengths, mask_batch, label_sent, label_mask)
        ...
        print('testing....')
        test(testing_data_index, testing_masks, model, label_sent, label_mask, test_lines)
    print('train over.')


def test(training_data_index, training_masks, model, label_sent, label_mask, test_lines):
...
if __name__ == '__main__':
    ...
    word2id={}
    test_file_path = '/scratch/wyin3/dickens_save_dataset/LORELEI/il9/il9-setE-as-test-input_ner_filtered_w2.txt'
    ...
    train(task1_data,task2_data,test_data, label_sent, label_mask, test_lines, config['epoch_num'], model, loss_function, optimizer)
