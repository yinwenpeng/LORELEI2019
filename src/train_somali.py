from load_data import load_BBN_multi_labels_dataset, load_il_groundtruth_as_testset, load_official_testData_il_and_MT, load_trainingData_types_plus_others,load_trainingData_types,load_SF_type_descriptions, average_f1_two_array_by_col, load_fasttext_multiple_word2vec_given_file, load_word2vec_to_init
...
if __name__ == '__main__':
    ...
    test_sents, test_masks, test_lines, word2id = load_official_testData_il_and_MT(word2id, config['maxSentLen'], test_file_paths, 0)
