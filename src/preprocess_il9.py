...
if __name__ == '__main__':
    dict_file = '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il9/source/il9/set0/docs/categoryI_dictionary/IL9_dictionary.txt'
    sub_dict_file = '/home/wyin3/LORELEI/2019/il9/il9_dictionary_w2w.txt'
    ltf_path = ['/shared/corpora/corporaWeb/lorelei/evaluation-2018/il9/source/il9/set0/data/monolingual_text/ltf/',
    '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il9/source/il9/set1/data/monolingual_text/ltf/',
    '/shared/corpora/corporaWeb/lorelei/evaluation-2018/il9/source/il9/setE/data/monolingual_text/il9/ltf/']
    mono_text = '/home/wyin3/LORELEI/2019/il9/raw.text.for.train.word2vec.txt'
    IL_mono_emb_file = '/home/wyin3/LORELEI/2019/il9/il9.w2v.txt'
    eng_mono_emb_file = '/home/wyin3/Datasets/word2vec_words_300d_insertedline0.txt'#'/home/wyin3/Datasets/wiki-news-300d-1M.vec'#'/home/wyin3/Datasets/word2vec_words_300d.txt'
    extract_dictionary(dict_file, sub_dict_file, True)
    extract_monolingual_text_4_train_word2vec(ltf_path, mono_text)
    run_word2vec(mono_text, IL_mono_emb_file)
    generate_bilingual_wordembeddings(eng_mono_emb_file, IL_mono_emb_file, sub_dict_file, 'il9longerw2vfulldict', True)
    ...
    # EDL_input = '/scratch/wyin3/dickens_save_dataset/LORELEI/il12/EDL/il12-exp1_bert0_tsl0_google1_top1_wc0_ed0_l2smap1_nilcluster_exact.tab'
    # output_file = '/scratch/wyin3/dickens_save_dataset/LORELEI/il12/il12-setE-as-test-input_edl_filtered'
    # docid2entity_pos_list = load_EDL2018_output(EDL_input)
